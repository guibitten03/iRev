...
class Net(nn.Module):
    def __init__(self, opt, uori='user'):
        ...
        self.cnn = nn.Conv2d(1, self.opt.filters_num, (1, 768))           
    ...
    def forward(self, reviews, ids, uori):
        ...
        att_weight = F.softmax(torch.bmm(review_fea.unsqueeze(1), attention_query.unsqueeze(2)), dim=1)
