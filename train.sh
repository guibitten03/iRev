...
# python3 main.py train --model=ANR --dataset=AMAZON_FASHION_data --emb_opt=word2vec --num-fea=1 --direct_output=True
# python3 main.py train --model=ANR --dataset=AMAZON_FASHION_data --emb_opt=fasttext --num-fea=1 --direct_output=True
...
# python3 main.py train --model=TAERT --dataset=AMAZON_FASHION_data --num-fea=1 

# python3 main.py train --model=CARL --dataset=AMAZON_FASHION_data --num-fea=3 

python3 main.py train --model=ALFM --dataset=AMAZON_FASHION_data --num_fea=1 --topics=True --direct_output=True 

python3 main.py train --model=A3NCF --dataset=AMAZON_FASHION_data --num_fea=1 --topics=True --direct_output=True 

python3 main.py train --model=CARP --dataset=AMAZON_FASHION_data --output=nfm 
